...
create table employee (id bigint not null AUTO_INCREMENT, email varchar(255), name varchar(255), phone_number varchar(255), wissen_id varchar(255), role_id bigint, password varchar(255), active bit default 0, primary key (id)) engine=InnoDB;
...
alter table schedule_slot add constraint FK11qi25rx553n1rtf6t5gmxuft foreign key (emp_id) references employee (id);
alter table employee add constraint FK4am1h1y1msy35hglg78wjiv2a foreign key (role_id) references roles (id);